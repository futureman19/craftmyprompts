...
export const CODING_DATA = [
  {
    ...
    subcategories: [
      { name: 'Languages', options: ['Python', 'TypeScript', 'JavaScript', 'Rust', 'Go', 'C++', 'Swift', 'SQL'] },
  ...
  },
  {
    ...
    subcategories: [
      { name: 'Action', options: ['Write Code', 'Debug', 'Refactor', 'Optimize', 'Explain Code', 'Write Unit Tests', 'Convert Language'] },
      { name: 'Focus', options: ['Performance', 'Readability', 'Security', 'Scalability'] }
    ]
  },
  {
    id: 'principles',
    ...
    subcategories: [
      { name: 'Paradigms', options: ['Functional Programming', 'OOP', 'Event-Driven'] },
      { name: 'Best Practices', options: ['SOLID Principles', 'DRY (Don\'t Repeat Yourself)', 'Clean Code', 'TDD (Test Driven Dev)'] }
    ]
  }
];
