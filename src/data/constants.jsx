...
export const PRESETS = {
    ...
    // --- CTO UPDATE: AVATAR PRESET ---
    avatar: [
        { label: "Pixar Style Avatar", avatar_style: "Pixar Style", framing: "Headshot", expression: "Confident", topic: "A cute 3D character of {Subject}." },
