...
import { Compass, Layout, MessageCircle, Mic, CheckCircle } from 'lucide-react';

// Stateless Component - Controlled by TextFeed
const EditorDeck = ({ data, selections, onSelect }) => {
            ...
            <div className="bg-slate-950 border-b border-slate-800 p-3 flex items-center justify-between shrink-0">
                <div className="flex items-center gap-4">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm font-bold text-white">Editor-in-Chief</span>
                    </div>
                    <div className="h-4 w-px bg-slate-800 hidden md:block" />
                    <p className="text-xs text-slate-500 truncate max-w-xs md:max-w-md hidden sm:block">
                        {data.strategy_summary || "Defining content strategy..."}
                    </p>
                </div>
            </div>
